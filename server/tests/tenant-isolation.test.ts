...
function crossTenantCases(owner: Tenant) {
  return [
    ...
    { method: "GET", path: `/api/tenders/${owner.tenderId}/runbook` },
    { method: "POST", path: `/api/tenders/${owner.tenderId}/runbook/step-sign-in-to-the-buyer-s-portal-as-the-registered-tenderer`, body: { done: true } },
...
test("TLY-93 AC3: every authenticated route is covered by a case here", () => {
  ...
  const covered = new Set([
    ...
    "POST /api/tenders/:id/answers/:questionId/draft-stream",
    "POST /api/tenders/:id/answers/:questionId/refine",
    ...
    "GET /api/tenders/:id/runbook", "POST /api/tenders/:id/runbook/:stepId",
